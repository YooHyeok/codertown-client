                ...
                , borderRadius:'2%', boxShadow: "5px 5px 5px rgba(0, 0, 0, 0.2)"}}>
                    <CardBody className="card-body">
                        ...
                        <div className="studyItem_schedule__3oAnA">
                            <p className="studyItem_scheduleTitle__1KN_9">목표기간 | {'16주'}</p>
                        </div>
                        <ul className="main_project_part_list_ul" style={{width:'240px', listStyle: 'none', margin:'0px', padding: '0'}}>
                            <li className="main_project_part_list_li">PM</li>
                            <li className="main_project_part_list_li">디자이너</li>
                            <li className="main_project_part_list_li">퍼블리셔</li>
                            <li className="main_project_part_list_li">백엔드</li>
                            <li className="main_project_part_list_li">프론트앤드</li>
                        </ul>
